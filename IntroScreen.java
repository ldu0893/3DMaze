...
public class IntroScreen extends JPanel implements ActionListener {
	...
	public void paintComponent(Graphics g) {
		...
		g.fillRoundRect((int) (width * .34) - 3, (int) (height * .5) + 2, (int) (width * .32), (int) (height * .14),
				(int) (width * .02), (int) (width * .02));
		g.fillRoundRect((int) (width * .34) - 3, (int) (height * .68) + 2, (int) (width * .32), (int) (height * .14),
				(int) (width * .02), (int) (width * .02));
		g.setColor(new Color(178, 0, 0));
		g.fillRoundRect((int) (width * .34), (int) (height * .5), (int) (int) (width * .32), (int) (height * .14),
				(int) (width * .02), (int) (width * .02));
		g.fillRoundRect((int) (width * .34), (int) (height * .68), (int) (int) (width * .32), (int) (height * .14),
				(int) (width * .02), (int) (width * .02));
