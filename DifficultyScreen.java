...
public class DifficultyScreen extends JPanel implements ActionListener {
	...
	public void paintComponent(Graphics g) {
		...
		g.setColor(new Color(96, 96, 96));
		g.fillRoundRect((int) (width * .0775) - 5, (int) (height * .6) + 4, (int) (width * .23), (int) (height * .18),
				(int) (width * .025), (int) (width * .025));
		g.fillRoundRect((int) (width * .385) - 5, (int) (height * .6) + 4, (int) (width * .23), (int) (height * .18),
				(int) (width * .025), (int) (width * .025));
		g.fillRoundRect((int) (width * .6925) - 5, (int) (height * .6) + 4, (int) (width * .23), (int) (height * .18),
				(int) (width * .025), (int) (width * .025));
		g.setColor(new Color(178, 0, 0));
		g.fillRoundRect((int) (width * .0775), (int) (height * .6), (int) (width * .23), (int) (height * .18),
				(int) (width * .025), (int) (width * .025));
		g.fillRoundRect((int) (width * .385), (int) (height * .6), (int) (width * .23), (int) (height * .18),
				(int) (width * .025), (int) (width * .025));
		g.fillRoundRect((int) (width * .6925), (int) (height * .6), (int) (width * .23), (int) (height * .18),
				(int) (width * .025), (int) (width * .025));
	}
