...
public class MapView extends JPanel {
	...
	public MapView(Game game, Maze maze) {
		...
		MenuBtn.setBounds(23 * frame.getWidth() / 25, frame.getHeight() / 35, frame.getWidth() / 17,
				frame.getWidth() / 25);
		...
		Up.setBounds(8 * frame.getWidth() / 100,
				(4 * frame.getHeight() / 10) + ((32 * frame.getHeight() / 100) - (4 * frame.getHeight() / 10)) / 2,
				frame.getWidth() / 36, frame.getHeight() / 11);
		Down.setBounds(8 * frame.getWidth() / 100, (3 * frame.getHeight() / 5) - frame.getHeight() / 17,
				frame.getWidth() / 36, frame.getHeight() / 11);
	...
	private class PaintGUI extends JPanel {
		public void paintComponent(Graphics g) {
			...
			for (int i = 1; i <= 3; i++) {
				...
				g.drawRoundRect(23 * frame.getWidth() / 25, i * frame.getHeight() / 35, frame.getWidth() / 17,
						frame.getWidth() / 100, 10, 15);
				g.setColor(Color.gray);
				g.fillRoundRect(23 * frame.getWidth() / 25, i * frame.getHeight() / 35, frame.getWidth() / 17,
						frame.getWidth() / 100, 10, 15);
			...
			g.setColor(green);
			g.fillPolygon(
					new int[] { 26 * frame.getWidth() / 30 + 15, (26 * frame.getWidth() / 30) + 80,
							((26 * frame.getWidth() / 30 + 15) + (26 * frame.getWidth() / 30) + 80) / 2 },
					new int[] { (14 * frame.getHeight() / 20) - 30, (14 * frame.getHeight() / 20) - 30,
							(14 * frame.getHeight() / 20) - 60 },
					3);
			g.setColor(Color.red);
			g.fillPolygon(
					new int[] { 26 * frame.getWidth() / 30 + 15, (26 * frame.getWidth() / 30) + 80,
							((26 * frame.getWidth() / 30 + 15) + (26 * frame.getWidth() / 30) + 80) / 2 },
					new int[] { (16 * frame.getHeight() / 20) - 60, (16 * frame.getHeight() / 20) - 60,
							(16 * frame.getHeight() / 20) - 30 },
					3);
			g.setColor(Color.blue);
			g.fillPolygon(
					new int[] { 26 * frame.getWidth() / 30 + 30, (26 * frame.getWidth() / 30) + 60,
							((26 * frame.getWidth() / 30 + 30) + (26 * frame.getWidth() / 30) + 60) / 2 },
					new int[] { (18 * frame.getHeight() / 20) - 30, (18 * frame.getHeight() / 20) - 30,
							(18 * frame.getHeight() / 20) - 80 },
					3);
			g.setColor(ground);
			g.fillPolygon(
					new int[] { 26 * frame.getWidth() / 30 + 30, (26 * frame.getWidth() / 30) + 60,
			...
			g.setColor(green);
			g.fillPolygon(
					new int[] { 2 * frame.getWidth() / 30, (2 * frame.getWidth() / 30) + arrowLength,
							((2 * frame.getWidth() / 30) + (2 * frame.getWidth() / 30) + arrowLength) / 2 },
					new int[] { (4 * frame.getHeight() / 10), (4 * frame.getHeight() / 10),
							(32 * frame.getHeight() / 100) },
					3);
			g.fillRect((arrowLength / 4) + (2 * frame.getWidth() / 30), (4 * frame.getHeight() / 10), arrowLength / 2,
					frame.getHeight() / 17);
			g.setColor(Color.red);
			g.fillPolygon(
					new int[] { 2 * frame.getWidth() / 30, (2 * frame.getWidth() / 30) + arrowLength,
							((2 * frame.getWidth() / 30) + (2 * frame.getWidth() / 30) + arrowLength) / 2 },
					new int[] { (3 * frame.getHeight() / 5), (3 * frame.getHeight() / 5),
							67 * frame.getHeight() / 100 },
					3);
			g.fillRect((arrowLength / 4) + (2 * frame.getWidth() / 30),
					(3 * frame.getHeight() / 5) - frame.getHeight() / 17, arrowLength / 2, frame.getHeight() / 17);
			...
			for (int i = 0; i < levelNum; i++) {
				for (int j = 0; j < levelNum; j++) {
					if (Player.roomVisited(i, j, currentLvl)) {
						...
						g.fillRect((i * BoxWidth) + 20 * frame.getWidth() / 100,
								(j * BoxHeight) + 20 * frame.getHeight() / 100, BoxWidth, BoxHeight);
						g.setColor(Color.black);
						if (Room.doors[0]) {
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100,
									(i * BoxWidth) + 20 * frame.getWidth() / 100 + (BoxWidth / 3),
									(j * BoxHeight) + 20 * frame.getHeight() / 100);
							g.drawLine((i * BoxWidth) + ((20 * frame.getWidth() / 100) + (2 * BoxWidth / 3)),
									(j * BoxHeight) + 20 * frame.getHeight() / 100,
									(i * BoxWidth) + 20 * frame.getWidth() / 100 + (BoxWidth),
									(j * BoxHeight) + 20 * frame.getHeight() / 100);
						} else {
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100,
									((i + 1) * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100);
						}
						if (Room.doors[1]) {
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100 + BoxWidth,
									(j * BoxHeight) + 20 * frame.getHeight() / 100,
									(i * BoxWidth) + 20 * frame.getWidth() / 100 + BoxWidth,
									(j * BoxHeight) + 20 * frame.getHeight() / 100 + (BoxHeight / 3));
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100 + BoxWidth,
									(j * BoxHeight) + 20 * frame.getHeight() / 100 + (2 * BoxHeight / 3),
									(i * BoxWidth) + 20 * frame.getWidth() / 100 + BoxWidth,
									(j * BoxHeight) + 20 * frame.getHeight() / 100 + BoxHeight);
						} else {
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100 + BoxWidth,
									(j * BoxHeight) + 20 * frame.getHeight() / 100,
									(i * BoxWidth) + 20 * frame.getWidth() / 100 + BoxWidth,
									((j + 1) * BoxHeight) + 20 * frame.getHeight() / 100);
						}
						if (Room.doors[2]) {
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100 + BoxHeight,
						...
						if (Room.doors[3]) {
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100,
									(i * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100 + (BoxHeight / 3));
							g.drawLine((i * BoxWidth) + 20 * frame.getWidth() / 100,
									(j * BoxHeight) + 20 * frame.getHeight() / 100 + (2 * BoxHeight / 3),
									(i * BoxWidth) + 20 * frame.getWidth() / 100,
						...
						if (Room.doors[4]) {
							g.setColor(green);
							g.fillPolygon(new int[] { (i * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 2,
									(i * BoxWidth) + ((20 * frame.getWidth() / 100) + BoxWidth / 2) - (BoxWidth / 4),
									(i * BoxWidth) + ((20 * frame.getWidth() / 100) + BoxWidth / 2) + (BoxWidth / 4) },
									new int[] { (j * BoxHeight) + 20 * frame.getHeight() / 100,
											(j * BoxHeight) + (20 * frame.getHeight() / 100) + (BoxWidth / 8),
											(j * BoxHeight) + (20 * frame.getHeight() / 100) + (BoxWidth / 8) },
									3);
						}
						if (Room.doors[5]) {
							...
							g.fillPolygon(new int[] { (i * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 2,
									(i * BoxWidth) + ((20 * frame.getWidth() / 100) + BoxWidth / 2) - (BoxWidth / 4),
									(i * BoxWidth) + ((20 * frame.getWidth() / 100) + BoxWidth / 2) + (BoxWidth / 4) },
									new int[] { ((j + 1) * BoxHeight) + 20 * frame.getHeight() / 100,
											((j + 1) * BoxHeight) + (20 * frame.getHeight() / 100) - (BoxWidth / 8),
											((j + 1) * BoxHeight) + (20 * frame.getHeight() / 100) - (BoxWidth / 8) },
									3);
						}
					} else if (!Player.roomVisited(i, j, currentLvl)) {
						g.setColor(ground);
						g.fillRect((i * BoxWidth) + 202 * frame.getWidth() / 1000,
								(j * BoxHeight) + 204 * frame.getHeight() / 1000, 95 * BoxWidth / 100,
								95 * BoxHeight / 100);
					}
				}
			...
			if (currentOrientation == 0) {
				...
				g.setColor(Color.blue);
				g.fillPolygon(
						new int[] { (currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 2,
						...
						new int[] { (currentPosition[1] * BoxHeight) + (20 * frame.getHeight() / 100) + BoxHeight / 5,
				...
				g.fillPolygon(
						new int[] { (currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 2,
								...
								(currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + 5 * BoxWidth / 8 },
						new int[] {
								(currentPosition[1] * BoxHeight) + (20 * frame.getHeight() / 100)
										+ 64 * BoxHeight / 100,
								(currentPosition[1] * BoxHeight) + (20 * frame.getHeight() / 100) + 4 * BoxHeight / 5,
								(currentPosition[1] * BoxHeight) + (20 * frame.getHeight() / 100) + 4 * BoxHeight / 5 },
						3);
				...
				g.setColor(Color.blue);
				g.fillPolygon(
						new int[] { (currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + 4 * BoxWidth / 5,
								(currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 5,
								(currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 5 },
						new int[] { (currentPosition[1] * BoxHeight) + (20 * frame.getHeight() / 100) + BoxHeight / 2,
				...
				g.setColor(Color.blue);
				g.fillPolygon(
						new int[] { (currentPosition[0] * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 5,
			...
			for (int i = 0; i < levelNum; i++) {
				...
				g.setFont(LabelFont);
				g.drawString(Label[i], (i * BoxWidth) + (20 * frame.getWidth() / 100) + BoxWidth / 2,
						(20 * frame.getHeight() / 100) - 30);
				g.drawString(Label[i], (20 * frame.getWidth() / 100) - 50,
						(i * BoxHeight) + (20 * frame.getHeight() / 100) + BoxHeight / 2);
			}
		}
	}
